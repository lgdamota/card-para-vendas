...
export default function Home() {
  return (
    <main className="app-shell relative isolate min-h-svh overflow-x-hidden bg-slate-950 shadow-[0_0_80px_rgba(0,0,0,0.55)] sm:mb-[clamp(1rem,3vw,2.5rem)] sm:rounded-b-[clamp(1.5rem,3vw,2.75rem)]">
